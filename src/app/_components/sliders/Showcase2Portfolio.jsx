...
const Showcase2PortfolioSlider = ({
  projects,
  order,
  slidesTitles,
  ...
  return (
    <>
        ...
        >
          {sliderItems.map((item, key) => (
            <SwiperSlide
              ...
              key={`portfolio-fs-slider2-item-${key}`}
            >
      ...
      <div className="mil-port-nav">
        <div className="mil-port-btn mil-prev mil-suptitle mil-c-gone">
          Prev
        </div>
        <div className="mil-port-btn mil-next mil-suptitle mil-c-gone">
          Next
        </div>
      </div>
    </>

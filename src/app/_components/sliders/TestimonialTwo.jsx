          ...
          <div className="row mil-aic mil-jcb mil-768-jcc">
            <div className="col-0 col-md-4">
              <img
                ...
                alt={Data.photo.alt}
                style={{ width: "100%" }}
                className="mil-reviews-image mil-up"
              />
            </div>
              ...
              >
                {Data.items.map((item, key) => (
                  <SwiperSlide
                    ...
                    key={`testimonial2-slider-item-${key}`}
                  >
                    <div
                      className="mil-review mil-left"
                      data-swiper-parallax="20%"
                      data-swiper-parallax-scale="0.5"
                      data-swiper-parallax-opacity="0"
                    >
                      <p className="mil-text mil-fs30 mil-light mil-mb60  mil-up">
                        {item.text}
                      </p>

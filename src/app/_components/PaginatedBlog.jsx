...
import BlogItem from "@/src/app/_components/blog/BlogItem";
  ...
  const onScroll = useCallback(async () => {
    if (
      window.innerHeight + window.scrollY >=
        document.querySelector(".mil-blog-container").offsetTop +
          document.querySelector(".mil-blog-container").offsetHeight &&
      !isLoading
    ) {
      await loadMoreData();
    }
          ...
          {/* {isLoading && (
            <div className="col-12">
              <div className="mil-more-loader mil-mt-60 mil-up">
                ...
                <p className="mil-text-16 mil-suptitle mil-light">
                  {loadingText}
                </p>
              </div>
            </div>

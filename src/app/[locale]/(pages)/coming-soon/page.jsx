          ...
          <div className="row mil-aic">
            <div className="col-12 col-lg-6">
              <div className="mil-banner-text">
                <h1
                  ...
                  dangerouslySetInnerHTML={{ __html: ComingSoonData.title }}
                />
                <p
                  className="mil-text mil-mb60 mil-light"
                  dangerouslySetInnerHTML={{ __html: ComingSoonData.subtitle }}
                />
                <form
                  action={AppData.settings.mailchimp.url}
                  method="post"
                  target="_blank"
                  className="mil-form mil-subscribe mil-up"
                >
                  <input
                  ...
                  <button type="submit" className="mil-btn mil-c-gone">
                    Subscribe
                  </button>
                </form>
              </div>
            ...
            <div className="col-12 col-lg-6 mil-banner-image-frame">
              <div className="mil-banner-img mil-out-right">
                <Image
                  src={ComingSoonData.image.url}
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                  priority
                  alt={ComingSoonData.image.alt}

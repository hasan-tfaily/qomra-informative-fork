...
async function Projects2() {
  ...
  const PortfolioData = {
    title:
      "<span class='mil-thin'>Production creative projects here! </span><br/>Welcome to <span class='mil-accent'>Okai</span>.",
      ...
      <div className="mil-banner-inner-2">
        <div className="container">
          <div className="mil-banner-text">
            <div>
              <h1
                className="mil-light mil-fs68 mil-mb30"
                dangerouslySetInnerHTML={{ __html: PortfolioData.title }}
              />
              <p className="mil-text mil-fs26 mil-up">
                {PortfolioData.text}{" "}
                <Link
                  href={PortfolioData.link.url}
                  className="mil-text-link mil-light mil-c-gone"
                >
                  {PortfolioData.link.label}
                </Link>
                !
              </p>
            </div>

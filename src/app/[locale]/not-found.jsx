...
const NotFound = () => {
  const NotFoundData = {
    title: "Oops!",
    description:
      "A connection cable has just been disconnected or is broken,<br/> please try again later or you can also go to the home page!",
    button: {
      link: "/",
              ...
              <div className="col-12 col-lg-6">
                <div className="mil-banner-text">
                  <h1
                    ...
                    dangerouslySetInnerHTML={{ __html: NotFoundData.title }}
                  />
                  <p
                    className="mil-text mil-mb60"
                    dangerouslySetInnerHTML={{
                      __html: NotFoundData.description,
                    }}
                  />
                  <Link
                    href={NotFoundData.button.link}
                    className="mil-btn mil-c-gone"
                  >
